<table>
  ...
  <tr>
    ...
    <td><img src="https://img.shields.io/badge/Frontend-HTML%2FCSS-blue" alt="HTML/CSS"></td>
  ...
  <tr>
    <td rowspan="2"><strong>Backend Development</strong></td>
    <td>Flask</td>
  ...
  <tr>
    <td rowspan="3"><strong>Machine Learning</strong></td>
    <td>Pandas</td>
  ...
  <tr>
    <td rowspan="2"><strong>Blockchain Integration</strong></td>
  ...
  <tr>
    <td rowspan="2"><strong>Cryptography and Security</strong></td>
    <td>Hashlib</td>
  ...
  <tr>
    <td rowspan="2"><strong>Additional Tools and Libraries</strong></td>
    <td>CSV & JSON</td>
  ...
  <tr>
    <td rowspan="2"><strong>Development Tools</strong></td>
    <td>Git</td>
